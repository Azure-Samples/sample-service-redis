...
func main() {
	...
	// For now look for managed env var names too, if dev isn't set
	if RedisHost == "" {
		RedisHost = os.Getenv("AZURE_REDIS_HOST")
		RedisPassword = os.Getenv("AZURE_REDIS_PASSWORD")
		RedisPort = os.Getenv("AZURE_REDIS_PORT")
		RedisSSL = os.Getenv("AZURE_REDIS_SSL")
	}
